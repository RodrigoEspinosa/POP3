...
namespace POP3.Models
{
    class Client: Person
    {
        ...
        public Client(String name, String email, String phone, String dni, bool sellsHisProperty, bool rentsHisProperty, bool wantToRentProperty, bool wantToBuyProperty, Image profilePicture)
            :base(name,dni,email,phone, profilePicture)
        {
